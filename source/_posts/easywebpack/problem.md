...
upateTime: 2019-10-13T12:34:10.000Z
wordCount: 2358
layout: doc
---
...
![image.png](https://cdn.nlark.com/yuque/0/2019/png/116733/1564828978624-a8e511e0-4500-4a12-8363-ccdfa3dd561e.png#align=left&display=inline&height=165&name=image.png&originHeight=362&originWidth=1720&search=&size=574785&status=done&width=781.8181648727294)
...
.babelrc 配置 babel 装饰器编译插件： [https://babeljs.io/docs/en/babel-plugin-proposal-decorators](https://babeljs.io/docs/en/babel-plugin-proposal-decorators)
...
目前 easywebpack 3 默认是 开启了 sass 功能，但安装 `node-sass` 时, 会出现安装不成功(二进制本地编译)的情况，这个时候可以按照如下方式禁用 node-sass .  **easywebpack 4** 已默认禁用。
...
see: [https://github.com/webpack/webpack/issues/2031](https://github.com/webpack/webpack/issues/2031)
...
如果要修复默认的publicPath，比如要修改 `/static/`，需要修改三个地方：
...
Egg 应用本地开发时, npm run dev 默认启动打开浏览器的端口是 7001, 如果要修改自动打开的端口为6001, 可以在 `config/config.local.js` 中 添加 端口配置
...
这时需要重新编译 node-sass:  `npm rebuild node-sass`  解决
